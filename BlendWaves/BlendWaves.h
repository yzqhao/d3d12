...
class BlendWaves : public D3DApp
{
	struct RenderItem;
public:
	BlendWaves(HINSTANCE hInstance);
	~BlendWaves();
...
private:
	...
	// FrameResource
	std::vector<std::unique_ptr<BlendWavesFR::FrameResource>> mFrameResources;
	BlendWavesFR::FrameResource* mCurrFrameResource = nullptr;
	...
	BlendWavesFR::PassConstants mMainPassCB;
