...
private:
	...
	// FrameResource
	std::vector<std::unique_ptr<CameraAndDynamicIndexingAppFR::FrameResource>> mFrameResources;
	CameraAndDynamicIndexingAppFR::FrameResource* mCurrFrameResource = nullptr;
	...
	CameraAndDynamicIndexingAppFR::PassConstants mMainPassCB;
