...
#include "CubeMap.h"
#include "../CubeMap/FrameResource.h"
...
void CubeMap::UpdateObjectCBs(const GameTimer& gt)
{
	...
	for (auto& e : mAllRitems)
	{
		...
		{
			CubeMapFR::ObjectConstants objConstants;
...
void CubeMap::UpdateMaterialBuffer(const GameTimer& gt)
{
	...
	for (auto& e : mMaterials)
	{
		...
		{
			CubeMapFR::MaterialData matData;
...
void CubeMap::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"CubeMap\\Default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"CubeMap\\Default.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["skyVS"] = d3dUtil::CompileShader(L"CubeMap\\Sky.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["skyPS"] = d3dUtil::CompileShader(L"CubeMap\\Sky.hlsl", nullptr, "PS", "ps_5_1");
...
void CubeMap::BuildFrameResources()
{
	...
	{
		mFrameResources.push_back(std::make_unique<CubeMapFR::FrameResource>(md3dDevice,
...
void CubeMap::BuildShapeGeometry()
{
	...
	std::vector<CubeMapFR::Vertex> vertices(totalVertexCount);
	...
	const uint vbByteSize = (uint)vertices.size() * sizeof(CubeMapFR::Vertex);
	...
	geo->VertexByteStride = sizeof(CubeMapFR::Vertex);
...
void CubeMap::BuildSkullGeometry()
{
	...
	std::vector<CubeMapFR::Vertex> vertices(vcount);
...
{
	uint objCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(CubeMapFR::ObjectConstants));
