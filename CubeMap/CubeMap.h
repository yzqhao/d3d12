...
private:
	...
	// FrameResource
	std::vector<std::unique_ptr<CubeMapFR::FrameResource>> mFrameResources;
	CubeMapFR::FrameResource* mCurrFrameResource = nullptr;
	...
	CubeMapFR::PassConstants mMainPassCB;
