...
class DynamicCube : public D3DApp
{
	struct RenderItem;
public:
	DynamicCube(HINSTANCE hInstance);
	~DynamicCube();
...
private:
	...
	// FrameResource
	std::vector<std::unique_ptr<DynamicCubeFR::FrameResource>> mFrameResources;
	DynamicCubeFR::FrameResource* mCurrFrameResource = nullptr;
	...
	DynamicCubeFR::PassConstants mMainPassCB;
	...
	ID3D12Resource* mCubeDepthStencilBuffer;
