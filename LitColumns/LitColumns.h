...
private:
	...
	// FrameResource
	std::vector<std::unique_ptr<LitColumnsFR::FrameResource>> mFrameResources;
	LitColumnsFR::FrameResource* mCurrFrameResource = nullptr;
	...
	LitColumnsFR::PassConstants mMainPassCB;
