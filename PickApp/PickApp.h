...
private:
	...
	// FrameResource
	std::vector<std::unique_ptr<PickAppFR::FrameResource>> mFrameResources;
	PickAppFR::FrameResource* mCurrFrameResource = nullptr;
	...
	PickAppFR::PassConstants mMainPassCB;
