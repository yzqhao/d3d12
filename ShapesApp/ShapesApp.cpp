...
#include "ShapesApp.h"
#include "../ShapesApp/FrameResource.h"
...
void ShapesApp::UpdateObjectCBs(const GameTimer& gt)
{
	...
	for (auto& e : mAllRitems)
	{
		...
		{
			Shapes::ObjectConstants objConstants;
...
void ShapesApp::BuildShadersAndInputLayout()
{
	...
	mvsByteCode = d3dUtil::CompileShader(L"ShapesApp\\color.hlsl", nullptr, "VS", "vs_5_0");
	mpsByteCode = d3dUtil::CompileShader(L"ShapesApp\\color.hlsl", nullptr, "PS", "ps_5_0");
...
{
	uint objCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(Shapes::ObjectConstants));
	...
	uint passCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(Shapes::PassConstants));
...
void ShapesApp::BuildFrameResources()
{
	...
	{
		mFrameResources.push_back(std::make_unique<Shapes::FrameResource>(md3dDevice,
...
void ShapesApp::BuildShapeGeometry()
{
	...
	std::vector<Shapes::Vertex> vertices(totalVertexCount);
	...
	const uint vbByteSize = (uint)vertices.size() * sizeof(Shapes::Vertex);
	...
	geo->VertexByteStride = sizeof(Shapes::Vertex);
