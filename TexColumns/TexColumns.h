...
private:
	...
	// FrameResource
	std::vector<std::unique_ptr<TexColumnsFR::FrameResource>> mFrameResources;
	TexColumnsFR::FrameResource* mCurrFrameResource = nullptr;
	...
	TexColumnsFR::PassConstants mMainPassCB;
